...
const middlewareUpload = multipart({uploadDir: './uploads/usuarios'})
...
api.post('/upload-image-user', [middlewareAuthentication.jwtAuth, middlewareUpload], userController.uploadImage)
// Don´t need JWT
